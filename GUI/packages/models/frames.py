...
class movementControl(tk.Frame):
	...
	def enable_depth_lock(self):
		if self.depthLockButton['text'] == "Depth Lock OFF":
			...
			# self.closedLoopPidReturnDict["depth"] = depth_PID(self.pres) Q: keeps yelling at me when i click depth lock that the movementControl object doesnt have the attribite 'pres'
